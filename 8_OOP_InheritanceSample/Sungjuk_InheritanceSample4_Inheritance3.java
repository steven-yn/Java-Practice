...
interface SungjukOutput3  {
	void SungjukOutput();
}

interface SungjukProcess3  {
	void SungjukProcess();
}

interface SungjukInput3 {
	void SungjukInput();

}

interface SungjukInputInwon3  {
	public abstract void SungjukInputInwon();
}
																//다중 상속의 효과
public class Sungjuk_InheritanceSample4_Inheritance3 implements SungjukInputInwon3, SungjukInput3, SungjukProcess3, SungjukOutput3 {
	...
	public static void main(String[] args) {
		Sungjuk_InheritanceSample4_Inheritance3 si =new Sungjuk_InheritanceSample4_Inheritance3();
