...
interface SungjukOutput44 {
	void SungjukOutput();
}

interface SungjukProcess44 {
	void SungjukProcess();
}

interface SungjukInput44 {
	void SungjukInput();
}

abstract class SungjukInputInwon44 {
	public abstract void SungjukInputInwon();
}

// 다중 상속의 효과
public class Sungjuk_InheritanceSample4_Inheritance4_abstractclass extends SungjukInputInwon44
		implements SungjukInput44, SungjukProcess44, SungjukOutput44 {
	...
	public static void main(String[] args) {
		Sungjuk_InheritanceSample4_Inheritance4_abstractclass si = new Sungjuk_InheritanceSample4_Inheritance4_abstractclass();
